                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {this.state.checkOrder === 1 ?
                                                    <button className="w3-btn w3-blue w3-round w3-small" style={{ marginRight: "18px" }} id="button/checkbill">
                                                        ต้องการชำระเงิน
                                    </button>
                                                    :
                                                    <button className="w3-btn w3-blue w3-round w3-small" onClick={this.ClickSubmit} style={{ marginRight: "18px" }} id="button/checkbill">
                                                        ต้องการชำระเงิน
                                   </button>
                                                }
